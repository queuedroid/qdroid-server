...
const docTemplate = `{
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/handlers.DeleteAllSessionsResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized, invalid or expired session token",
    ...
    "definitions": {
        ...
        "handlers.DeleteAllSessionsResponse": {
            "type": "object",
            "properties": {
                "deleted_count": {
                ...
                "message": {
                    "description": "Message indicating successful operation",
                    "type": "string",
                    "example": "All other sessions deleted successfully"
                },
                "total_sessions": {
                    "description": "Total number of sessions before deletion",
                    "type": "integer",
                    "example": 4
                }
            }
        ...
        "handlers.SessionDetails": {
            ...
            "properties": {
                ...
                "ip_address": {
                    "description": "IP address of the session (if available)",
                    "type": "string",
                    "example": "192.168.1.1"
                },
                "is_current": {
        ...
        "handlers.SessionListResponse": {
            ...
            "properties": {
                "data": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.SessionDetails"
                    }
                },
                "message": {
                    "description": "Message indicating successful retrieval",
